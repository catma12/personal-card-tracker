...
export const knownCards: KnownCardInfo[] = [
  ...
  },
  {
    ...
    benefits: [
      { name: 'United TravelBank Cash', creditType: 'anniversary-year', valueType: 'dollar', totalAmount: 200, notes: '$200 United TravelBank cash on account opening and each anniversary.' },
      { name: '10K Award Flight Discount', creditType: 'anniversary-year', valueType: 'points', totalAmount: 10000, notes: '10,000-mile award flight discount starting first anniversary.' },
      { name: '10K Award Flight Discount (Spend)', creditType: 'annual', valueType: 'points', totalAmount: 10000, notes: '10,000-mile award flight discount after $20K spend each calendar year.' },
      ...
      { name: 'Rideshare Credit', creditType: 'monthly', valueType: 'dollar', totalAmount: 8, notes: '$8/mo Jan–Nov, $12 Dec ($100/yr). Yearly opt-in required.' },
      { name: 'Instacart Credit', creditType: 'monthly', valueType: 'dollar', totalAmount: 15, notes: '$10 + $5 Instacart credit/mo ($180/yr). Ends 12/31/27.' },
      ...
      { name: 'Avis/Budget Rental Credit', creditType: 'anniversary-year', valueType: 'dollar', totalAmount: 80, notes: '$40 TravelBank cash per rental, up to $80/yr via cars.united.com.' },
      { name: 'Global Entry / TSA PreCheck Credit', creditType: 'one-time', valueType: 'dollar', totalAmount: 100, notes: 'Up to $100 every 4 years.' },
    ],
    eligibilityRules: [
