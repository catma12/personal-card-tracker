...
export const OFFER_DATA_LAST_UPDATED = '2026-05-04';
...
export const knownCards: KnownCardInfo[] = [
  // ==================== CHASE ====================
  {
    ...
    highestHistoricalOffer: { amount: '100,000 points', spendRequirement: '$5,000 in 3 months' },
    ...
    benefits: [
      ...
      { name: 'DoorDash Credits', creditType: 'monthly', valueType: 'dollar', totalAmount: 10, notes: '$10/mo DoorDash credit on restaurants ($120/yr).' },
    ],
    eligibilityRules: [
  ...
  // ==================== AMERICAN EXPRESS ====================
  {
    ...
    benefits: [
      { name: 'Uber Cash Credit', creditType: 'monthly', valueType: 'dollar', totalAmount: 15, notes: '$15/mo Uber Cash; December total is $35 ($15 regular + $20 bonus). Total $200/yr. Must add Amex Platinum to Uber account.' },
      ...
      { name: 'Digital Entertainment Credit', creditType: 'monthly', valueType: 'dollar', totalAmount: 25, notes: '$25/mo for Disney+, Disney+ Bundle, ESPN streaming, Hulu, NYT, Paramount+, Peacock, WSJ, YouTube Premium, YouTube TV.' },
      { name: 'Saks Credit (H1)', creditType: 'semi-annual', valueType: 'dollar', totalAmount: 50, notes: '$50 Jan–Jun at Saks. Final period — Saks benefit ends July 1, 2026 (Saks bankruptcy).' },
      ...
      { name: 'Hotel Credit (H1)', creditType: 'semi-annual', valueType: 'dollar', totalAmount: 300, notes: '$300 Jan–Jun for prepaid Fine Hotels + Resorts or The Hotel Collection (min. 2-night stay for Hotel Collection).' },
      { name: 'Hotel Credit (H2)', creditType: 'semi-annual', valueType: 'dollar', totalAmount: 300, notes: '$300 Jul–Dec for prepaid Fine Hotels + Resorts or The Hotel Collection (min. 2-night stay for Hotel Collection).' },
      { name: 'Walmart+ Credit', creditType: 'monthly', valueType: 'dollar', totalAmount: 12.95, notes: 'Covers Walmart+ membership (~$155/yr including tax).' },
      { name: 'Resy Dining Credit', creditType: 'quarterly', valueType: 'dollar', totalAmount: 100, notes: '$100/quarter at eligible U.S. Resy restaurants ($400/yr).' },
      { name: 'Lululemon Credit', creditType: 'quarterly', valueType: 'dollar', totalAmount: 75, notes: '$75/quarter at U.S. lululemon retail or online ($300/yr).' },
      ...
      { name: 'Global Entry / TSA PreCheck Credit', creditType: 'one-time', valueType: 'dollar', totalAmount: 120, notes: 'Up to $120 every 4 years (Global Entry fee).' },
    ],
    eligibilityRules: [
  ...
  },
  {
    ...
    benefits: [
      { name: 'Uber Cash Credit', creditType: 'monthly', valueType: 'dollar', totalAmount: 15, notes: '$15/mo Uber Cash; December total is $35 ($15 regular + $20 bonus). Total $200/yr.' },
      { name: 'Uber One Credit', creditType: 'annual', valueType: 'dollar', totalAmount: 120, notes: 'Up to $120/yr statement credit for Uber One membership.' },
      { name: 'Digital Entertainment Credit', creditType: 'monthly', valueType: 'dollar', totalAmount: 25, notes: '$25/mo for Disney+, Disney+ Bundle, ESPN streaming, Hulu, NYT, Paramount+, Peacock, WSJ, YouTube Premium, YouTube TV.' },
      { name: 'Saks Credit (H1)', creditType: 'semi-annual', valueType: 'dollar', totalAmount: 50, notes: '$50 Jan–Jun at Saks. Final period — Saks benefit ends July 1, 2026 (Saks bankruptcy).' },
      { name: 'Airline Incidental Credit', creditType: 'annual', valueType: 'dollar', totalAmount: 200, notes: 'Select one airline per calendar year.' },
      { name: 'Hotel Credit (H1)', creditType: 'semi-annual', valueType: 'dollar', totalAmount: 300, notes: '$300 Jan–Jun for prepaid Fine Hotels + Resorts or The Hotel Collection.' },
      { name: 'Hotel Credit (H2)', creditType: 'semi-annual', valueType: 'dollar', totalAmount: 300, notes: '$300 Jul–Dec for prepaid Fine Hotels + Resorts or The Hotel Collection.' },
      { name: 'Walmart+ Credit', creditType: 'monthly', valueType: 'dollar', totalAmount: 12.95, notes: 'Covers Walmart+ membership (~$155/yr including tax).' },
      { name: 'Resy Dining Credit', creditType: 'quarterly', valueType: 'dollar', totalAmount: 100, notes: '$100/quarter at eligible U.S. Resy restaurants ($400/yr).' },
      { name: 'Lululemon Credit', creditType: 'quarterly', valueType: 'dollar', totalAmount: 75, notes: '$75/quarter at U.S. lululemon retail or online ($300/yr).' },
      { name: 'CLEAR Plus Credit', creditType: 'annual', valueType: 'dollar', totalAmount: 209, notes: 'Up to $209/yr statement credit for CLEAR+ membership.' },
      { name: 'Global Entry / TSA PreCheck Credit', creditType: 'one-time', valueType: 'dollar', totalAmount: 120, notes: 'Up to $120 every 4 years (Global Entry fee).' },
    ],
    eligibilityRules: [
  ...
  },
  {
    ...
    annualFee: 95,
    category: 'hotel',
    currentOffer: { amount: '4 Free Night Awards (up to 50K each)', spendRequirement: '$3,000 in 3 months + $4,000 in 4 months' },
    highestHistoricalOffer: { amount: '5 Free Night Awards (up to 50K each)', spendRequirement: '$3,000 in 3 months' },
    ...
    benefits: [
      ...
      { name: 'Airline Credit (H1)', creditType: 'semi-annual', valueType: 'dollar', totalAmount: 50, notes: '$50 Jan–Jun after $250 qualifying airline spend. New 2026 Boundless benefit.' },
      { name: 'Airline Credit (H2)', creditType: 'semi-annual', valueType: 'dollar', totalAmount: 50, notes: '$50 Jul–Dec after $250 qualifying airline spend. New 2026 Boundless benefit.' },
    ],
    eligibilityRules: [
  ...
  },
  {
    ...
    annualFee: 95,
    category: 'hotel',
    currentOffer: { amount: '60,000 points', spendRequirement: '$3,000 in 3 months + bonus points on spend' },
    highestHistoricalOffer: { amount: '5 Free Night Certificates (Category 1-4)', spendRequirement: '$5,000 in 3 months' },
  ...
  // ==================== AIRLINE CARDS ====================
  {
    ...
    benefits: [
      { name: 'United Club Passes', creditType: 'annual', valueType: 'certificate', totalAmount: 2, notes: '2 United Club one-time passes per year (~$59 retail value each).' },
      ...
      { name: 'United Hotels Credit', creditType: 'anniversary-year', valueType: 'dollar', totalAmount: 100, notes: 'Up to $100/yr for United Hotels bookings ($50 per stay, max 2 stays per anniversary year).' },
      ...
      { name: 'Instacart Credit', creditType: 'monthly', valueType: 'dollar', totalAmount: 10, notes: '$10/mo Instacart credit ($120/yr). Valid through Dec 31, 2027.' },
      { name: 'JSX Charter Credit', creditType: 'anniversary-year', valueType: 'dollar', totalAmount: 100, notes: 'Up to $100 per anniversary year booked directly with JSX.' },
      { name: 'Avis/Budget Rental Credit', creditType: 'anniversary-year', valueType: 'dollar', totalAmount: 50, notes: '$25 TravelBank cash per rental, up to $50/yr (2 rentals) via cars.united.com.' },
      { name: 'Global Entry / TSA PreCheck Credit', creditType: 'one-time', valueType: 'dollar', totalAmount: 120, notes: 'Up to $120 every 4 years (Global Entry fee).' },
    ],
    eligibilityRules: [
  ...
  },
  {
    ...
    annualFee: 350,
    category: 'airline',
    currentOffer: { amount: '90,000 miles + 3,000 PQP', spendRequirement: '$4,000 in 3 months' },
    highestHistoricalOffer: { amount: '90,000 miles + 3,000 PQP', spendRequirement: '$4,000 in 3 months' },
    applyUrl: 'https://creditcards.chase.com/travel-credit-cards/united/quest',
    benefits: [
      { name: 'United TravelBank Cash', creditType: 'anniversary-year', valueType: 'dollar', totalAmount: 200, notes: '$200 United TravelBank cash on account opening and each anniversary year.' },
      { name: '10K Award Flight Discount', creditType: 'anniversary-year', valueType: 'points', totalAmount: 10000, notes: '10,000-mile award flight discount each anniversary year.' },
      { name: '10K Award Flight Discount (Spend)', creditType: 'annual', valueType: 'points', totalAmount: 10000, notes: '10,000-mile award flight discount after $20K spend each calendar year.' },
      { name: 'Renowned Hotels Credit', creditType: 'anniversary-year', valueType: 'dollar', totalAmount: 150, notes: 'Up to $150 for prepaid Renowned Hotels & Resorts bookings per anniversary year.' },
      { name: 'Rideshare Credit', creditType: 'monthly', valueType: 'dollar', totalAmount: 8, notes: '$8/mo Jan–Nov, $12 in December ($100/yr total). Yearly opt-in required.' },
      { name: 'Instacart Credit', creditType: 'monthly', valueType: 'dollar', totalAmount: 15, notes: '$10 + $5 Instacart credit per month ($180/yr total). Valid through Dec 31, 2027.' },
      { name: 'JSX Charter Credit', creditType: 'anniversary-year', valueType: 'dollar', totalAmount: 150, notes: 'Up to $150 per anniversary year booked directly with JSX.' },
      { name: 'Avis/Budget Rental Credit', creditType: 'anniversary-year', valueType: 'dollar', totalAmount: 80, notes: '$40 TravelBank cash per rental, up to $80/yr (2 rentals) via cars.united.com.' },
      { name: 'Global Entry / TSA PreCheck Credit', creditType: 'one-time', valueType: 'dollar', totalAmount: 120, notes: 'Up to $120 every 4 years (Global Entry fee).' },
    ],
    eligibilityRules: [
